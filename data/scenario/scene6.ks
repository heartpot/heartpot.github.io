...
[cm  ]
[stopbgm  time="1000"  ]
[bg  time="8000"  method="crossfade"  storage="background/scholar_cave.jpg"  ]
[playbgm  volume="100"  time="1000"  loop="true"  storage="Moonlight_Gaze.ogg"  ]
...
Thanks Nesuka for the ending song "Moonlight gaze".[p]
Background music pack: Dead Seed[p]
Water sound effect: Inspectorj[p]
Underwater sound: Hisoul[p]
Seawave sound: Luftrum[p]
